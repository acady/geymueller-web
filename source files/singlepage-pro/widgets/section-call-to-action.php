...
class Singlepage_Action extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'singlepage_action_widget', 'description' => __( 'Display a call to action block.', 'singlepage') );
        parent::__construct(false, $name = __('Singlepage FP: Call to action', 'singlepage'), $widget_ops);
		$this->alt_option_name = 'singlepage_action_widget';
    }
	...
	<p><label for="<?php echo $this->get_field_id('action_text'); ?>"><?php _e('Enter your call to action.', 'singlepage'); ?></label>
	...
	<p><label for="<?php echo $this->get_field_id('action_btn_link'); ?>"><?php _e('Link for the button', 'singlepage'); ?></label>
	...
	<p><label for="<?php echo $this->get_field_id('action_btn_text'); ?>"><?php _e('Title for the button', 'singlepage'); ?></label>
	...
	<label for="<?php echo $this->get_field_id( 'inline' ); ?>"><?php _e( 'Display the button inline with the text?', 'singlepage' ); ?></label></p>
	<?php
	}
