...
if ( ! function_exists( 'ot_display_by_type' ) ) {
  ...
  function ot_display_by_type( $args = array() ) {
    ...
    if ( function_exists( $function_name_by_type ) ) {
      ...
      echo '<p>' . __( 'Sorry, this function does not exist', 'singlepage' ) . '</p>';
    }
      ...
      echo '<div class="format-setting-inner">'; 
        ...
        echo '<div class="ot-background-group">';
          ...
          if ( in_array( 'background-repeat', $ot_recognized_background_fields ) ) {
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[background-repeat]" id="' . esc_attr( $field_id ) . '-repeat" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
              ...
              echo '<option value="">' . __( 'background-repeat', 'singlepage' ) . '</option>';
          ...
          if ( in_array( 'background-attachment', $ot_recognized_background_fields ) ) {
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[background-attachment]" id="' . esc_attr( $field_id ) . '-attachment" class="option-tree-ui-select ' . $field_class . '">';
              ...
              echo '<option value="">' . __( 'background-attachment', 'singlepage' ) . '</option>';
          ...
          if ( in_array( 'background-position', $ot_recognized_background_fields ) ) {
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[background-position]" id="' . esc_attr( $field_id ) . '-position" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
              ...
              echo '<option value="">' . __( 'background-position', 'singlepage' ) . '</option>';
          ...
          if ( in_array( 'background-size', $ot_recognized_background_fields ) ) {
            ...
            if ( is_array( $choices ) && ! empty( $choices ) ) {
              ...
              echo '<input type="text" name="' . esc_attr( $field_name ) . '[background-size]" id="' . esc_attr( $field_id ) . '-size" value="' . ( isset( $field_value['background-size'] ) ? esc_attr( $field_value['background-size'] ) : '' ) . '" class="widefat ot-background-size-input option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . __( 'background-size', 'singlepage' ) . '" />';
        ...
        if ( in_array( 'background-image', $ot_recognized_background_fields ) ) {
          ...
          echo '<div class="option-tree-ui-upload-parent">';
            ...
            /* input */
            echo '<input type="text" name="' . esc_attr( $field_name ) . '[background-image]" id="' . esc_attr( $field_id ) . '" value="' . ( isset( $field_value['background-image'] ) ? esc_attr( $field_value['background-image'] ) : '' ) . '" class="widefat option-tree-ui-upload-input ' . esc_attr( $field_class ) . '" placeholder="' . __( 'background-image', 'singlepage' ) . '" />';
            
            /* add media button */
            echo '<a href="javascript:void(0);" class="ot_upload_media option-tree-ui-button button button-primary light" rel="' . $post_id . '" title="' . __( 'Add Media', 'singlepage' ) . '"><span class="icon ot-icon-plus-circle"></span>' . __( 'Add Media', 'singlepage' ) . '</a>';
          ...
          if ( isset( $field_value['background-image'] ) && $field_value['background-image'] !== '' ) {
            ...
            echo '<div class="option-tree-ui-media-wrap" id="' . esc_attr( $field_id ) . '_media">';
              ...
              echo '<a href="javascript:(void);" class="option-tree-ui-remove-media option-tree-ui-button button button-secondary light" title="' . __( 'Remove Media', 'singlepage' ) . '"><span class="icon ot-icon-minus-circle"></span>' . __( 'Remove Media', 'singlepage' ) . '</a>';
    ...
    echo '<div class="format-setting type-category-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( ! empty( $categories ) ) {
          ...
          echo '<p>' . __( 'No Categories Found', 'singlepage' ) . '</p>';
        }
    ...
    echo '<div class="format-setting type-custom-post-type-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
          ...
          echo '<p>' . __( 'No Posts Found', 'singlepage' ) . '</p>';
        }
    ...
    echo '<div class="format-setting type-custom-post-type-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
          ...
          echo '<option value="">' . __( 'No Posts Found', 'singlepage' ) . '</option>';
        }
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( ! empty( $ids ) ) {
          ...
          <div class="ot-gallery-buttons">
            <a href="#" class="option-tree-ui-button button button-secondary hug-left ot-gallery-delete">' . __( 'Delete Gallery', 'singlepage' ) . '</a>
            <a href="#" class="option-tree-ui-button button button-primary right hug-right ot-gallery-edit">' . __( 'Edit Gallery', 'singlepage' ) . '</a>
          </div>';
          ...
          echo '
          <div class="ot-gallery-buttons">
            <a href="#" class="option-tree-ui-button button button-primary right hug-right ot-gallery-edit">' . __( 'Create Gallery', 'singlepage' ) . '</a>
          </div>';
  ...
  function ot_type_list_item( $args = array() ) {
    ...
    echo '<div class="format-setting type-list-item ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* button */
        echo '<a href="javascript:void(0);" class="option-tree-list-item-add option-tree-ui-button button button-primary right hug-right" title="' . __( 'Add New', 'singlepage' ) . '">' . __( 'Add New', 'singlepage' ) . '</a>';
        
        /* description */
        echo '<div class="list-item-description">' . apply_filters( 'ot_list_item_description', __( 'You can re-order with drag & drop, the order will update after saving.', 'singlepage' ), $field_id ) . '</div>';
    ...
    echo '<div class="format-setting type-radio ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        $field_choices = array(
          array(
            'value'   => 'on',
            'label'   => __( 'On', 'singlepage' ),
          ),
          array(
            'value'   => 'off',
            'label'   => __( 'Off', 'singlepage' ),
          )
        );
  ...
  function ot_type_page_checkbox( $args = array() ) {
    ...
    echo '<div class="format-setting type-page-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
        ...
        echo '<p>' . __( 'No Pages Found', 'singlepage' ) . '</p>';
      }
    ...
    echo '<div class="format-setting type-page-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
          ...
          echo '<option value="">' . __( 'No Pages Found', 'singlepage' ) . '</option>';
        }
  ...
  function ot_type_sidebar_select( $args = array() ) {
    ...
    echo '<div class="format-setting type-sidebar-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* has sidebars */
        if ( count( $sidebars ) ) {
          echo '<option value="">-- ' . __( 'Choose Sidebar', 'singlepage' ) . ' --</option>';
          foreach ( $sidebars as $id => $sidebar ) {
            echo '<option value="' . esc_attr( $id ) . '"' . selected( $field_value, $id, false ) . '>' . esc_attr( $sidebar ) . '</option>';
          }
        } else {
          echo '<option value="">' . __( 'No Sidebars', 'singlepage' ) . '</option>';
        }
  ...
  function ot_type_slider( $args = array() ) {
    ...
    echo '<div class="format-setting type-slider ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* description */
        echo '<div class="list-item-description">' . __( 'You can re-order with drag & drop, the order will update after saving.', 'singlepage' ) . '</div>';
  ...
  function ot_type_social_links( $args = array() ) {
    ...
    if ( empty( $field_value ) && apply_filters( 'ot_type_social_links_load_defaults', true, $field_id ) ) {
      ...
      $field_value = apply_filters( 'ot_type_social_links_defaults', array(
        array(
          'name'    => __( 'Facebook', 'singlepage' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => __( 'Twitter', 'singlepage' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => __( 'Google+', 'singlepage' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => __( 'LinkedIn', 'singlepage' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => __( 'Pinterest', 'singlepage' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => __( 'Youtube', 'singlepage' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => __( 'Dribbble', 'singlepage' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => __( 'Github', 'singlepage' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => __( 'Forrst', 'singlepage' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => __( 'Digg', 'singlepage' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => __( 'Delicious', 'singlepage' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => __( 'Tumblr', 'singlepage' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => __( 'Skype', 'singlepage' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => __( 'SoundCloud', 'singlepage' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => __( 'Vimeo', 'singlepage' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => __( 'Flickr', 'singlepage' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => __( 'VK.com', 'singlepage' ),
          'title'   => '',
          'href'    => ''
        )
      ), $field_id );
    ...
    echo '<div class="format-setting type-social-list-item ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* button */
        echo '<a href="javascript:void(0);" class="option-tree-social-links-add option-tree-ui-button button button-primary right hug-right" title="' . __( 'Add New', 'singlepage' ) . '">' . __( 'Add New', 'singlepage' ) . '</a>';
        
        /* description */
        echo '<div class="list-item-description">' . apply_filters( 'ot_social_links_description', __( 'You can re-order with drag & drop, the order will update after saving.', 'singlepage' ), $field_id ) . '</div>';
    ...
    echo '<div class="format-setting type-tag-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( $tags ) {
          ...
          echo '<p>' . __( 'No Tags Found', 'singlepage' ) . '</p>';
        }
    ...
    echo '<div class="format-setting type-tag-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( $tags ) {
          ...
          echo '<option value="">' . __( 'No Tags Found', 'singlepage' ) . '</option>';
        }
    ...
    echo '<div class="format-setting type-taxonomy-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( $taxonomies ) {
          ...
          echo '<p>' . __( 'No Taxonomies Found', 'singlepage' ) . '</p>';
        }
    ...
    echo '<div class="format-setting type-tag-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( $taxonomies ) {
          ...
          echo '<option value="">' . __( 'No Taxonomies Found', 'singlepage' ) . '</option>';
        }
