...
class Hoo_FullWidth {
	...
	public function __construct() {
		...
		add_filter( 'hoo_attr_fullwidth-shortcode', array( $this, 'attr' ) );
	...
	function render( $args, $content = '') {
		...
		if( $defaults['menu_anchor'] ) {
			$html = sprintf( '<div id="%s"><div %s><div %s>%s</div></div></div>', $defaults['menu_anchor'], HooCore_Plugin::attributes( 'fullwidth-shortcode' ), HooCore_Plugin::attributes( 'singlepage-row' ), do_shortcode( $content ) );
		} else {
			$html = sprintf( '<div %s><div %s>%s</div></div>', HooCore_Plugin::attributes( 'fullwidth-shortcode' ), HooCore_Plugin::attributes( 'singlepage-row' ), do_shortcode( $content ) );
		}
	...
	function attr() {
		...
		$attr['class'] = 'singlepage-fullwidth fullwidth-box';
		$attr['style'] = '';
