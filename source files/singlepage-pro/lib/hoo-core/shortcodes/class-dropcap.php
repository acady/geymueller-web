...
class Hoo_Dropcap {
	...
	public function __construct() {
		...
		add_filter( 'hoo_attr_dropcap-shortcode', array( $this, 'attr' ) );
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( '<span %s>%s</span>', HooCore_Plugin::attributes( 'dropcap-shortcode' ), do_shortcode( $content ) );
	...
	function attr() {
		...
		$attr['class'] = 'singlepage-dropcap dropcap';
		$attr['style'] = '';
