	...
	<div id="wl-wrapper" class="product woocommerce">
		...
		<?php if ( $wishlist_items && count( $wishlist_items ) ) : ?>
			<?php if ( isset( $_GET['preview'] ) && $_GET['preview'] ) : ?>
				<div class="woocommerce-info woocommerce_info"><a href="<?php echo $wishlist->the_url_edit(); ?>" class="button"><?php _e( 'Return to your view', 'wc_wishlist' ); ?></a> <?php _e( 'This is how other people will see your Wish List', 'wc_wishlist' ); ?></div>
			<?php endif; ?>

			<div class="wl-intro">
				
				<p class="alert">
                    <?php _e( 'Name of Owner', 'wc_wishlist' ); ?><br/>
					<strong><?php echo get_userdata($wl_owner)->display_name; ?></strong><br/>
		...
		<?php else : ?>
			...
			<div class="woocommerce-info woocommerce_info"> <?php _e( 'This list currently contains no items.', 'wc_wishlist' ); ?></div>
			<?php endif; ?>
