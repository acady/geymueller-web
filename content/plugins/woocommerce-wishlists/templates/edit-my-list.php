...
<a href="<?php echo wp_logout_url(); ?>" class="pull-right">
  Logout
</a>

  <p>
    <strong><?php _e( 'Name of Owner', 'wc_wishlist' ); ?></strong><br/>
    <?php echo get_userdata($wl_owner)->display_name; ?>
  </p>
  <p>
    <strong><?php _e( 'Description of Owner', 'wc_wishlist' ); ?></strong><br/>
    <?php echo get_userdata($wl_owner)->description; ?>
  </p>
...
<div id="wl-wrapper" class="product woocommerce"> <!-- product class so woocommerce stuff gets applied in tabs -->
	...
	<div class="wl-tab-wrap woocommerce-tabs">
		...
		<uib-tabset>
			<uib-tab heading="<?php _e( 'List Items', 'wc_wishlist' ); ?>">
			...
			<uib-tab heading="<?php _e( 'Settings', 'wc_wishlist' ); ?>">
				<div class="wl-form">
					<form  action="" enctype="multipart/form-data" method="post">
						...
						<table class="wl-rad-table">
							...
							<tr>
								<td><input type="radio" name="wishlist_sharing" id="rad_pub" value="Public" <?php checked( 'Public', $sharing ); ?>><label for="rad_pub"><?php _e( 'Public', 'wc_wishlist' ); ?> <span class="wl-small">- <?php _e( 'Anyone can search for and see this list. You can also share using a link.', 'wc_wishlist' ); ?></span></label></td>
							</tr>
						</table>
						</div>
