...
<div class="product-images images">
	<div id="product-images" class="flexslider" data-zoom="<?php echo $product_zoom; ?>">
				<?php if (singlepage_out_of_stock()) {
					echo '<span class="badge out-of-stock">' . __( 'Out of Stock', 'singlepage' ) . '</span>';
				} else if ( $product->is_on_sale() ) {
					echo apply_filters('woocommerce_sale_flash', '<span class="badge onsale">'.__( 'Sale', 'singlepage' ).'</span>', $post, $product);
				} ?>
            ...
            <li itemprop="image" class="zoom-small-image ">
            	<a href="<?php echo $src[0]; ?>" class='cloud-zoom' rel="tint:'#999',tintOpacity:0.5,smoothMove:5,zoomWidth:480,adjustY:0,adjustX:10" itemprop="image"><img src="<?php echo $src_small[0]; ?>" class="single-product-thumb" title="<?php echo $image_title; ?>" /></a><div style="display:none;" id="winSelector"></div>
					...
					<?php if ( $attachment_ids ) {						
							...
							foreach ( $attachment_ids as $attachment_id ) {
								...
								?>
									<li itemprop="image" class="zoom-small-image">
										<a href="<?php echo $src[0]; ?>" class='cloud-zoom' rel="tint:'#999',tintOpacity:0.5,smoothMove:5,zoomWidth:480,adjustY:0,adjustX:10" itemprop="image"><img class="single-product-thumb" src="<?php echo $src_small[0]; ?>" title="<?php echo $image_title; ?>" /></a><div style="display:none;" id="winSelector"></div>
