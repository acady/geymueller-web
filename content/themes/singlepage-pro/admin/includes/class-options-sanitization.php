...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'singlepage' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'singlepage' ),
		'repeat-y'  => __( 'Repeat Vertically', 'singlepage' ),
		'repeat'    => __( 'Repeat All', 'singlepage' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'singlepage' ),
		'top center'    => __( 'Top Center', 'singlepage' ),
		'top right'     => __( 'Top Right', 'singlepage' ),
		'center left'   => __( 'Middle Left', 'singlepage' ),
		'center center' => __( 'Middle Center', 'singlepage' ),
		'center right'  => __( 'Middle Right', 'singlepage' ),
		'bottom left'   => __( 'Bottom Left', 'singlepage' ),
		'bottom center' => __( 'Bottom Center', 'singlepage' ),
		'bottom right'  => __( 'Bottom Right', 'singlepage')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'singlepage' ),
		'fixed'  => __( 'Fixed in Place', 'singlepage')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'singlepage' ),
		'italic'      => __( 'Italic', 'singlepage' ),
		'bold'        => __( 'Bold', 'singlepage' ),
		'bold italic' => __( 'Bold Italic', 'singlepage' )
		);
