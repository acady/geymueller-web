define(['controllers/module', 'openseadragon', 'd3'], function (controllers, openseadragon, d3) {
  ...
  controllers.controller(
      ...
      ['$scope', '$q', '$http', '$timeout', 'hit', 'descriptions', 'ensembles', 'data', 'searchkeyword', 'hideClose',
        'config', 'imageservice', 'dataservice',
        function ($scope, $q, $http, $timeout, hit, descriptions, ensembles, data, searchkeyword, hideClose, config,
