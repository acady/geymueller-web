  ...
  <div class="row">
    ...
    <div class="col-sm-6">
      <div class="pathview-container" id="path_attributes">
        ...
        <br>
        <div class="text-left"><i class="data_attr_group" ng-bind-html="trustAsHtml(selectedTreeData.group)"></i>
        </div>
        <hr>

        <span ng-if="selectedTreeData.title">Name:  <span class="data_attr"
                                                          ng-bind-html="trustAsHtml(selectedTreeData.title)"></span><br/>
        <span ng-if="selectedTreeData.data_title">
        <button ng-if="selectedTreeData.data_title" type="button" class="btn btn-default btn-add-data-text"
                ng-click="toggleTitleCollapsed()"><div
            class="btn-add-data-text-title">{{selectedTreeData.data_title}}</div></button><br/>
        <div uib-collapse="!titleCollapsed">
          <div class="data_attr_more" ng-bind-html="trustAsHtml(selectedTreeData.data_title)"></div>
        </div>
      </span>

      <span ng-if="selectedTreeData.sex">Geschlecht: <span class="data_attr"
                                                           ng-bind-html="trustAsHtml(selectedTreeData.sex)"></span><br/>
        <button ng-if="selectedTreeData.data_sex" type="button" class="btn btn-default btn-add-data-text"
                ng-click="toggleSexCollapsed()"><div
            class="btn-add-data-text-title">{{selectedTreeData.data_sex}}</div></button><br/>
        <div uib-collapse="!sexCollapsed">
          <div class="data_attr_more" ng-bind-html="trustAsHtml(selectedTreeData.data_sex)"></div>
        </div>
      </span>

      <span ng-if="selectedTreeData.stand">dStand: <span class="data_attr"
                                                         ng-bind-html="trustAsHtml(selectedTreeData.stand)"></span><br/>
        <button ng-if="selectedTreeData.data_stand" type="button" class="btn btn-default btn-add-data-text"
                ng-click="toggleStandCollapsed()"><div
            class="btn-add-data-text-title">{{selectedTreeData.data_stand}}</div></button><br/>
      ...
      <span ng-if="selectedTreeData.gestus">Gestus:  <span class="data_attr"
                                                           ng-bind-html="trustAsHtml(selectedTreeData.gestus)"></span><br/>
        <button ng-if="selectedTreeData.data_gestus" type="button" class="btn btn-default btn-add-data-text"
                ng-click="toggleGestusCollapsed()"><div class="btn-add-data-text-title">{{selectedTreeData.data_gestus}}</div></button><br/>
        <div uib-collapse="!gestusCollapsed">
          <div class="data_attr_more" ng-bind-html="trustAsHtml(selectedTreeData.data_gestus)"></div>
        </div>
      </span>

      <span ng-if="selectedTreeData.farbe">Farbe: <span class="data_attr"
                                                        ng-bind-html="trustAsHtml(selectedTreeData.farbe)"></span><br/>
        <button ng-if="selectedTreeData.data_farbe" type="button" class="btn btn-default btn-add-data-text"
                ng-click="toggleFarbeCollapsed()""><div class="btn-add-data-text-title">{{selectedTreeData.data_farbe}}</div>
        </button><br/>
      ...
      <span ng-if="selectedTreeData.form">Form: <span class="data_attr"
                                                      ng-bind-html="trustAsHtml(selectedTreeData.form)"></span><br/>
        <button ng-if="selectedTreeData.data_form" type="button" class="btn btn-default btn-add-data-text"
                ng-click="toggleFormCollapsed()"><div
            class="btn-add-data-text-title">{{selectedTreeData.data_form}}</div></button><br/>
        <div uib-collapse="!formCollapsed">
          <div class="data_attr_more" ng-bind-html="trustAsHtml(selectedTreeData.data_form)"></div>
        </div>
      </span>

      <span ng-if="selectedTreeData.material">Material: <span class="data_attr"
                                                              ng-bind-html="trustAsHtml(selectedTreeData.material)"></span><br/>
        <button ng-if="selectedTreeData.data_material" type="button" class="btn btn-default btn-add-data-text"
                ng-click="toggleMaterialCollapsed()"><div class="btn-add-data-text-title">{{selectedTreeData.data_material}}</div></button><br/>
        <div uib-collapse="!materialCollapsed">
          <div class="data_attr_more" ng-bind-html="trustAsHtml(selectedTreeData.data_material)"></div>
        </div>
      </span>

      <span ng-if="selectedTreeData.text">Text: <span class="data_attr"
                                                      ng-bind-html="trustAsHtml(selectedTreeData.text)"></span><br/>
        <button ng-if="selectedTreeData.data_text" type="button" class="btn btn-default btn-add-data-text"
                ng-click="toggleTextCollapsed()"><div
            class="btn-add-data-text-title">{{selectedTreeData.data_text}}</div></button><br/>
      ...
      <img ng-if="selectedTreeData.imageRect" class="attr_tree_image"
           ng-src="{{selectedTreeData.imageRect | ampersandhtml}}" alt="Rechteck Tag"></img>
      <br/>
      <img ng-if="selectedTreeData.imagePoint" class="attr_tree_image"
           ng-src="{{selectedTreeData.imagePoint | ampersandhtml}}" alt="Point Tag"/></img>
  ...
  <div class="modal-body">
      ...
      <uib-tab ng-if="ensembles.length">
        ...
        <div class="row">
          <div class="imagepreview-column" ng-repeat="ensemble in ensembles">
            <img ng-src="{{ retrieveImageUrl(ensemble) }}" ng-click="$close();openModal(ensemble);"
      ...
      <uib-tab>
        ...
        <div class="row">
          ...
          <div class="col-sm-4"><h4>Lokalisierung</h4>
            ...
            <p><span class="additional_info_medium">Fol: </span><span ng-repeat="hit_fol in hit.fol track by $index"
            ...
            <p><span class="additional_info_medium">Dia Nr.: </span><span
                ng-repeat="hit_dianr in hit.dianr track by $index" ng-bind-html="hit_dianr | highlight:searchkeyword"
    ...
    <uib-tabset>
      <uib-tab>
        ...
        <p><span class="additional_info_medium">persistent link:</span> <a href="detail/?archivnr={{ hit.archivnr }}">Zum
      ...
      <uib-tab heading="Themen">
        <p><span class="additional_info_medium">Bildthema:</span><span
            ng-repeat="hit_bildthema in hit.bildthema track by $index"> {{ hit_bildthema }} </span></p>
        <p><span class="additional_info_medium">Anbringung:</span>
        <div ng-repeat="hit_anbringung in hit.anbringung track by $index"> {{ hit_anbringung }}</div>
        </p>
        <p><span class="additional_info_medium">Quelle:</span>
      ...
      <uib-tab heading="Herstellung">
        <p><span class="additional_info_medium">KünsterIn:</span><span
            ng-repeat="hit_kuenstler in hit.kuenstler track by $index"> {{ hit_kuenstler }}</span></p>
        ...
        <p><span class="additional_info_medium">Entstehungsort:</span><span
            ng-repeat="hit_entstehungsort in hit.entstehungsort track by $index">{{ hit_entstehungsort }}</span></p>
      ...
      <uib-tab heading="Bildträger">
        ...
        <p><span class="additional_info_medium">Objektart:</span><span
            ng-repeat="hit_objektart in hit.objektart track by $index"> {{ hit_objektart }}</span></p>
        ...
        <p><span class="additional_info_medium">Maße:</span><span ng-repeat="hit_masze in hit.masze track by $index"> {{ hit_masze }}</span>
        </p>
      ...
      <uib-tab heading="Lokalisierung">
        ...
        <p><span class="additional_info_medium">Institution:</span><span
            ng-repeat="hit_institution in hit.institution track by $index"> {{ hit_institution }}</span></p>
        <p><span class="additional_info_medium">Herkunft:</span> {{ hit.herkunft }}</p>
        <p><span class="additional_info_medium">InvNr:</span><span ng-repeat="hit_invnr in hit.invnr track by $index"> {{ hit_invnr }}</span>
        </p>
        <p><span class="additional_info_medium">Fol:</span><span ng-repeat="hit_fol in hit.fol track by $index"> {{ hit_fol }}</span>
        </p>
        <p><span class="additional_info_medium">Provenienz:</span><span
            ng-repeat="hit_provenienz in hit.provenienz track by $index"> {{ hit_provenienz }}</span></p>
    ...
    <ul>
      <li ng-repeat="facetValue in searchResult.facet_counts.facet_fields[facetConfig.facetfield] track by $index"
        ...
        <input type="checkbox" ng-click="toggleFacetValue(facetValue)" ng-checked="isRefined(facetValue)"
               id="facet-checkbox"/>
        <label for="facet-checkbox"><input type="checkbox" ng-click="toggleNotFacetValue(facetValue)"
                                           ng-checked="isNot(facetValue)" id="facet-checkbox-second"/>
        </label><label class="check-exclude" for="facet-checkbox-second"><a href="" class="facet-link toggle-refine"
...
<script type="text/ng-template" id="/antepostfacet.html">
  <facetcontainer facet-title="facetTitle">
    <input type="checkbox" class="facet-check-antepost" id="chk_exactmatch" ng-model="antepostfacetconfig.exactmatch"
    ...
    <div ng-if="!antepostfacetconfig.exactmatch">
      ...
      <input type="radio" class="facet-check-antepost" id="chk_contain" name="antepostfacet.mode"
             ng-model="antepostfacetconfig.mode" class="form-control" value="contain" ng-change="modeChanged()">
      ...
      <input type="radio" class="facet-check-antepost" id="chk_overlap" name="antepostfacet.mode"
             ng-model="antepostfacetconfig.mode" class="form-control" value="overlap" ng-change="modeChanged()">
...
<search index-name="<?php echo get_field('indexname'); ?>" ng-cloak="">
  ...
  <div class="search-main-container">
    ...
    <uib-tabset active="tabIndex" class="search-tabs">
      ...
      <button type="button" class="remove-facet-value"
              ng-click="toggleFacetValue(currentSearch.selectedFacets, facetTitleKey, facetEntryKey)">&times;</button>
    </span>
          </div>
        </div>
          ...
          <div class="search-container">
            <div class="collection-input-container form-group has-icon-left">
              <input id="search-input" type="text" autocomplete="off" spellcheck="false" autocorrect="off"
                     placeholder="Suchtext oder Archivnummer eingeben..." class="form-control"
                     ng-model="currentSearch.searchtext"><select class="form-control"
                                                                 ng-model="currentSearch.searchfield">
              ...
              foreach ($facettabs as $facettab) {
                ...
                $facettabindex++; ?>" heading="<?php echo $facettab['title']; ?>">
                  ...
                  <?php if ($facettab['title'] == 'Werke') { ?>
                    <antepostfacet current-search="currentSearch" search-result="searchResults[searchResultsIndex]"
                  ...
                  <?php if ($facettab['hierarchicalfacets'] != '') { ?>
                    <hierarchicalfacet facet-config="tmpFacetConfig" current-search="currentSearch"
                                       search-result="searchResults[searchResultsIndex]" disjunctive="true"
          ...
          <div class="col-sm-9">
            <div class="row">
              ...
              <div class="search-celltype">
                <select class="btn sort-pages btn-secondary dropdown-toggle" ng-model="currentSearch.rows"
            ...
            <div class="row">
              <div class="search-pagination">
                <div uib-pagination ng-change="pageChanged()" ng-model="currentSearch.page"
                     ...
                     items-per-page="searchResults[searchResultsIndex].responseHeader.params.rows" max-size="10"
