module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		jshint : {
			all : ['js/*.js', '!js/bootstrap.js', '!js/video.js', '!js/bigvideo.js', '!js/smoothscroll.js', '!js/respond.js', '!js/modernizr.custom.js', '!js/jquery.easing.1.3.js',
				'!js/html5.js', '!js/jquery-ui.js', '!js/common.js', '!js/admin.js', '!js/modernizr.js', '!js/*.min.js', '!js/vendor/**/*.js'],
			options : {
				browser: true,
				curly: false,
				eqeqeq: false,
